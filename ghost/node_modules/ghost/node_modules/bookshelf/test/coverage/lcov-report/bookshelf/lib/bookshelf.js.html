...
<div class="header medium">
    ...
    <h2>
        ...
        Lines: <span class="metric">53.62% <small>(37 / 69)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cstat-no" title="statement not covered" >      if (type !== 'morphTo' &amp;&amp; !_lodash2['default'].isFunction(Target)) {</span>
...
<span class="cstat-no" title="statement not covered" >      return new bookshelf.Collection(models || [], _lodash2['default'].extend({}, options, { model: this }));</span>
    },
&nbsp;
    /**
     * @method Model.count
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (_lodash2['default'].isString(_plugin)) {</span>
...
<span class="cstat-no" title="statement not covered" >            require(_plugin)(this, options);</span>
      ...
      } else <span class="cstat-no" title="statement not covered" >if (_lodash2['default'].isArray(_plugin)) {</span>
<span class="cstat-no" title="statement not covered" >        _lodash2['default'].each(_plugin, <span class="fstat-no" title="function not covered" >function (p) {</span></span>
...
<span class="cstat-no" title="statement not covered" >    var inst = Object.create(this.prototype);</span>
<span class="cstat-no" title="statement not covered" >    var obj = this.apply(inst, arguments);</span>
<span class="cstat-no" title="statement not covered" >    return Object(obj) === obj ? obj : inst;</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  function builderFn(tableName) {</span>
<span class="cstat-no" title="statement not covered" >    var _this2 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var builder = tableName ? knex(tableName) : knex.queryBuilder();</span>
&nbsp;
...
&nbsp;
  ...
  ['where', 'query'].forEach(function (method) {
    Model[method] = Collection[method] = <span class="fstat-no" title="function not covered" >function () {</span>
