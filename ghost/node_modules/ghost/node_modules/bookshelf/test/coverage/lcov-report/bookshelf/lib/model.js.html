...
<html lang="en">
<head>
    <title>Code coverage report for bookshelf/lib/model.js</title>
    <meta charset="utf-8">
...
<div class="header low">
    <h1>Code coverage report for <span class="entity">bookshelf/lib/model.js</span></h1>
    <h2>
        Statements: <span class="metric">37.21% <small>(48 / 129)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">25.61% <small>(21 / 82)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">17.07% <small>(7 / 41)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">38.21% <small>(47 / 123)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">bookshelf/lib/</a> &#187; model.js</div>
</div>
<div class="body">
...
&nbsp;
   ...
   * @returns {Model}
   */
  hasOne: <span class="fstat-no" title="function not covered" >function hasOne(Target, foreignKey) {</span>
<span class="cstat-no" title="statement not covered" >    return this._relation('hasOne', Target, { foreignKey: foreignKey }).init(this);</span>
  },
&nbsp;
  /**
   ...
   * @returns {Collection}
   */
  hasMany: <span class="fstat-no" title="function not covered" >function hasMany(Target, foreignKey) {</span>
<span class="cstat-no" title="statement not covered" >    return this._relation('hasMany', Target, { foreignKey: foreignKey }).init(this);</span>
  },
&nbsp;
  /**
   ...
   * @returns {Model}
   */
  belongsTo: <span class="fstat-no" title="function not covered" >function belongsTo(Target, foreignKey) {</span>
<span class="cstat-no" title="statement not covered" >    return this._relation('belongsTo', Target, { foreignKey: foreignKey }).init(this);</span>
  },
&nbsp;
  /**
   ...
   * @returns {Collection}
   */
  belongsToMany: <span class="fstat-no" title="function not covered" >function belongsToMany(Target, joinTableName, foreignKey, otherKey) {</span>
...
<span class="cstat-no" title="statement not covered" >    var columnNames = undefined,</span>
...
<span class="cstat-no" title="statement not covered" >      candidates = _lodash2['default'].rest(arguments, 2);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      columnNames = null;</span>
<span class="cstat-no" title="statement not covered" >      candidates = _lodash2['default'].rest(arguments);</span>
    }
...
&nbsp;
   ...
   * @returns {Collection}
   */
  through: <span class="fstat-no" title="function not covered" >function through(Interim, throughForeignKey, otherKey) {</span>
<span class="cstat-no" title="statement not covered" >    return this.relatedData.through(this, Interim, { throughForeignKey: throughForeignKey, otherKey: otherKey });</span>
  },
&nbsp;
  /**
...
&nbsp;
  _doFetch: _basePromise2['default'].method(<span class="fstat-no" title="function not covered" >function (attributes, options) {</span>
...
<span class="cstat-no" title="statement not covered" >        if (options.require) <span class="cstat-no" title="statement not covered" >throw new this.constructor.NotFoundError('EmptyResponse');</span></span>
<span class="cstat-no" title="statement not covered" >        return _basePromise2['default'].reject(null);</span>
      }
    })
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return this.triggerThen('fetched', this, response, options);</span>
    })['return'](this)['catch'](<span class="fstat-no" title="function not covered" >function (err) {</span>
<span class="cstat-no" title="statement not covered" >      if (err === null) <span class="cstat-no" title="statement not covered" >return err;</span></span>
...
&nbsp;
   ...
   */
  load: _basePromise2['default'].method(<span class="fstat-no" title="function not covered" >function (relations, options) {</span>
<span class="cstat-no" title="statement not covered" >    return _basePromise2['default'].bind(this).then(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      return [this.format(_lodash2['default'].extend(Object.create(null), this.attributes))];</span>
    }).then(<span class="fstat-no" title="function not covered" >function (response) {</span>
<span class="cstat-no" title="statement not covered" >      return this._handleEager(response, _lodash2['default'].extend({}, options, {</span>
        shallow: true,
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (key == null || <span class="branch-1 cbranch-no" title="branch not covered" >typeof key === "object")</span> {
      attrs = key || {};
      options = _lodash2['default'].clone(val) || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
    } else {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (method === 'insert' || <span class="branch-1 cbranch-no" title="branch not covered" >options.defaults)</span> {
...
<span class="cstat-no" title="statement not covered" >          attrs = _lodash2['default'].extend({}, defaults, this.attributes, attrs);</span>
        }
      }
&nbsp;
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.hasTimestamps) {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.relatedData &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.relatedData.type !== 'morphTo')</span> {
...
&nbsp;
       ...
       * @returns {Promise}
       */
      return this.triggerThen(method === 'insert' ? 'creating saving' : <span class="branch-1 cbranch-no" title="branch not covered" >'updating saving',</span> this, attrs, options).bind(this).then(function () {
        return sync[options.method](method === 'update' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >options.patch </span>? <span class="branch-0 cbranch-no" title="branch not covered" >attrs </span>: this.attributes);
      }).then(function (resp) {
&nbsp;
        // After a successful database save, the id is updated if the model was created
        <span class="missing-if-branch" title="else path not taken" >E</span>if (method === 'insert' &amp;&amp; this.id == null) {
...
&nbsp;
         ...
         * @returns {Promise}
         */
        return this.triggerThen(method === 'insert' ? 'created saved' : <span class="branch-1 cbranch-no" title="branch not covered" >'updated saved',</span> this, resp, options);
      });
    })['return'](this);
  }),
&nbsp;
   ...
   */
  destroy: _basePromise2['default'].method(<span class="fstat-no" title="function not covered" >function (options) {</span>
<span class="cstat-no" title="statement not covered" >    options = options ? _lodash2['default'].clone(options) : {};</span>
...
<span class="cstat-no" title="statement not covered" >    var args = _lodash2['default'].toArray(arguments);</span>
...
&nbsp;
module.exports = BookshelfModel;</pre></td></tr>
</table></pre>
