...
<html lang="en">
<head>
    <title>Code coverage report for bookshelf/lib/collection.js</title>
    <meta charset="utf-8">
...
<div class="header low">
    <h1>Code coverage report for <span class="entity">bookshelf/lib/collection.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">bookshelf/lib/</a> &#187; collection.js</div>
</div>
<div class="body">
...
&nbsp;
   ...
   */
  through: <span class="fstat-no" title="function not covered" >function through(Interim, foreignKey, otherKey) {</span>
<span class="cstat-no" title="statement not covered" >    return this.relatedData.through(this, Interim, { throughForeignKey: foreignKey, otherKey: otherKey });</span>
  },
&nbsp;
  /**
   ...
   */
  fetch: _basePromise2['default'].method(<span class="fstat-no" title="function not covered" >function (options) {</span>
...
<span class="cstat-no" title="statement not covered" >        if (options.require) <span class="cstat-no" title="statement not covered" >throw new this.constructor.EmptyError('EmptyResponse');</span></span>
...
<span class="cstat-no" title="statement not covered" >      if (err !== null) <span class="cstat-no" title="statement not covered" >throw err;</span></span>
...
&nbsp;
   ...
   */
  count: _basePromise2['default'].method(<span class="fstat-no" title="function not covered" >function (column, options) {</span>
<span class="cstat-no" title="statement not covered" >    if (!_lodash2['default'].isString(column)) {</span>
...
<span class="cstat-no" title="statement not covered" >    if (options) <span class="cstat-no" title="statement not covered" >options = _lodash2['default'].clone(options);</span></span>
...
&nbsp;
   ...
   */
  fetchOne: _basePromise2['default'].method(<span class="fstat-no" title="function not covered" >function (options) {</span>
...
<span class="cstat-no" title="statement not covered" >    if (!_lodash2['default'].isArray(relations)) <span class="cstat-no" title="statement not covered" >relations = [relations];</span></span>
<span class="cstat-no" title="statement not covered" >    options = _lodash2['default'].extend({}, options, { shallow: true, withRelated: relations });</span>
...
&nbsp;
   ...
   * model}.
   */
  create: _basePromise2['default'].method(<span class="fstat-no" title="function not covered" >function (model, options) {</span>
<span class="cstat-no" title="statement not covered" >    options = options ? _lodash2['default'].clone(options) : {};</span>
...
<span class="cstat-no" title="statement not covered" >        return this.attach(model, _lodash2['default'].omit(options, 'query'));</span>
      }
...
<span class="cstat-no" title="statement not covered" >    var relatedData = this.relatedData;</span>
<span class="cstat-no" title="statement not covered" >    this.set(response, { silent: true, parse: true }).invoke('_reset');</span>
