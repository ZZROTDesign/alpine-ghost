...
<html lang="en">
<head>
    <title>Code coverage report for bookshelf/lib/base/model.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">bookshelf/lib/base/model.js</span></h1>
    <h2>
        Statements: <span class="metric">93.89% <small>(123 / 131)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">bookshelf/lib/base/</a> &#187; model.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">202088</span>
<span class="cline-any cline-yes">202088</span>
<span class="cline-any cline-yes">202088</span>
<span class="cline-any cline-yes">202088</span>
<span class="cline-any cline-yes">202088</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">202897</span>
<span class="cline-any cline-yes">202897</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">202897</span>
<span class="cline-any cline-yes">202849</span>
<span class="cline-any cline-yes">202849</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">202897</span>
<span class="cline-any cline-yes">405840</span>
<span class="cline-any cline-yes">405840</span>
<span class="cline-any cline-yes">405652</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">405732</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">202897</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">200345</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">203408</span>
<span class="cline-any cline-yes">203408</span>
<span class="cline-any cline-yes">203408</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span></td><td class="text"><pre class="prettyprint lang-js">// Base Model
// ---------------
'use strict';
&nbsp;
...
function ModelBase(attributes, options) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (options) {
    ...
    if (options.parse) attrs = this.parse(attrs, options) || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
  }
...
ModelBase.prototype.set = function (key, val, options) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (key == null) <span class="cstat-no" title="statement not covered" >return this;</span>
  var attrs;
&nbsp;
...
ModelBase.prototype.serialize = function (options) {
  ...
  for (var key in relations) {
    ...
    attrs[key] = relation.toJSON ? relation.toJSON(options) : <span class="branch-1 cbranch-no" title="branch not covered" >relation;</span>
  }
  <span class="missing-if-branch" title="if path not taken" >I</span>if (options &amp;&amp; options.omitPivot) <span class="cstat-no" title="statement not covered" >return attrs;</span>
  if (this.pivot) {
...
<span class="cstat-no" title="statement not covered" >  return _.escape(this.get(key));</span>
};
&nbsp;
/**
 * @method
...
<span class="cstat-no" title="statement not covered" >  return this.set(attr, void 0, _.extend({}, options, { unset: true }));</span>
};
&nbsp;
/**
 * @method
...
ModelBase.prototype.related = function (name) {
  return this.relations[name] || (this[name] ? this.relations[name] = this[name]() : <span class="branch-1 cbranch-no" title="branch not covered" >void 0)</span>;
};
&nbsp;
/**
 * @method
...
<span class="cstat-no" title="statement not covered" >    args.unshift(this.attributes);</span>
<span class="cstat-no" title="statement not covered" >    return _[method].apply(_, args);</span>
  };
});
&nbsp;
/**
...
&nbsp;
module.exports = ModelBase;</pre></td></tr>
</table></pre>
