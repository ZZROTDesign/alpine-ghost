...
<html lang="en">
<head>
    <title>Code coverage report for bookshelf/lib/base/collection.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">bookshelf/lib/base/collection.js</span></h1>
    <h2>
        Statements: <span class="metric">80.83% <small>(156 / 193)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">72.92% <small>(70 / 96)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">58.33% <small>(21 / 36)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">82.18% <small>(143 / 174)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">bookshelf/lib/base/</a> &#187; collection.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">913</span>
<span class="cline-any cline-yes">200797</span>
<span class="cline-any cline-yes">200797</span>
<span class="cline-any cline-yes">200349</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">200766</span>
<span class="cline-any cline-yes">200765</span>
<span class="cline-any cline-yes">200765</span>
<span class="cline-any cline-yes">200765</span>
<span class="cline-any cline-yes">200765</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">410</span>
<span class="cline-any cline-yes">200792</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">200080</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">88</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">200827</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">200833</span>
<span class="cline-any cline-yes">200816</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span></td><td class="text"><pre class="prettyprint lang-js">// Base Collection
// ---------------
&nbsp;
...
function CollectionBase(models, options) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!_.isFunction(this.model)) {
...
&nbsp;
    ...
    if (existing) {
      ...
      if (merge) {
        attrs = attrs === model ? <span class="branch-0 cbranch-no" title="branch not covered" >model.attributes </span>: attrs;
...
&nbsp;
      // This is a new model, push it to the `toAdd` list.
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!(model = this._prepareModel(attrs, options))) <span class="cstat-no" title="statement not covered" >continue;</span>
        toAdd.push(model);
...
&nbsp;
  ...
  if (toAdd.length || order &amp;&amp; order.length) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (at != null) {
...
<span class="cstat-no" title="statement not covered" >  return Promise.bind(context).thenReturn(this.models).reduce(iterator, initialValue).bind();</span>
};
&nbsp;
CollectionBase.prototype.fetch = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  return Promise.rejected('The fetch method has not been implemented');</span>
};
&nbsp;
/**
 * @method
...
CollectionBase.prototype.remove = function (models, options) {
  ...
  while (++i &lt; models.length) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!model) <span class="cstat-no" title="statement not covered" >continue;</span>
    delete this._byId[model.id];
    delete this._byId[model.cid];
    var index = this.indexOf(model);
    this.models.splice(index, 1);
    this.length = this.length - 1;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!options.silent) {
      options.index = index;
...
<span class="cstat-no" title="statement not covered" >  return this.add(model, _.extend({ at: this.length }, options));</span>
};
&nbsp;
/**
 * @method
...
<span class="cstat-no" title="statement not covered" >  return this.add(model, _.extend({ at: 0 }, options));</span>
};
&nbsp;
/**
 * @method
...
<span class="cstat-no" title="statement not covered" >  if (_.isString(this.comparator) || this.comparator.length === 1) {</span>
<span class="cstat-no" title="statement not covered" >    this.models = this.sortBy(this.comparator, this);</span>
  } else {
<span class="cstat-no" title="statement not covered" >    this.models.sort(_.bind(this.comparator, this));</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  return this.invoke('get', attr);</span>
};
&nbsp;
/**
 * @method
...
<span class="cstat-no" title="statement not covered" >    var iterator = _.isFunction(value) ? value : <span class="fstat-no" title="function not covered" >function (model) {</span></span>
<span class="cstat-no" title="statement not covered" >      return model.get(value);</span>
    };
<span class="cstat-no" title="statement not covered" >    return _[method](this.models, iterator, context);</span>
  };
});
&nbsp;
/**
...
&nbsp;
module.exports = CollectionBase;</pre></td></tr>
</table></pre>
